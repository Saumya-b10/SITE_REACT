...
const Footer = () => {
  ...
  return (
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 bg-gray-50">
      {/* Top Section */}
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-600">
        ...
        <div>
          <div className="flex items-center space-x-2">
            ...
            />
            <h2 className="text-xl font-bold text-gray-900">Monastery360</h2>
          </div>
      ...
      <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
        ...
        <span className="font-medium text-gray-800">Monastery360</span>. All
        Rights Reserved.
      </p>
    </footer>
  );
